...
interface HoverBtnProps extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

const HoverBtn: React.FC<HoverBtnProps> = ({
  width = 511,
  height = 153,
  ...props
}) => (
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_2003_279"
        />
        <feColorMatrix
          in="SourceAlpha"
          type="matrix"
        ...
        <feBlend
          mode="normal"
          in2="effect1_dropShadow_2003_279"
          result="effect2_dropShadow_2003_279"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect2_dropShadow_2003_279"
          result="shape"
        />
      </filter>
      <filter
        id="filter1_dd_2003_279"
        x={0.681192}
        y={1}
        width={509.517}
        height={151.473}
